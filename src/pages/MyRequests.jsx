    ...
    <div className="bg-white dark:bg-slate-800 p-5 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 hover:border-brand-200 dark:hover:border-brand-900 transition-colors group">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 rounded-lg bg-brand-50 dark:bg-brand-900/20 flex items-center justify-center text-brand-700 dark:text-brand-400 shrink-0">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-1 text-sm text-gray-500 dark:text-gray-400">
              <span className="flex items-center gap-1">
                ...
                {request.fecha_factura
                  ? new Date(
                      request.fecha_factura + "T00:00:00",
              ...
              {/* --- NUEVO: APROBADOR --- */}
              <span className="flex items-center gap-1 text-brand-600 bg-brand-50 px-1.5 py-0.5 rounded text-xs font-medium border border-brand-100">
        ...
        {/* Estado y Monto */}
        <div className="flex items-center justify-between sm:justify-end gap-4 w-full sm:w-auto border-t sm:border-t-0 border-gray-100 pt-3 sm:pt-0 mt-2 sm:mt-0">
          <span
            className={cn(
          ...
          <div className="text-right">
            ...
            <span className="text-lg font-bold text-brand-700 dark:text-brand-400 flex items-center justify-end">
              S/{" "}
